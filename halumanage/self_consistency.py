...
import halumanage
from halumanage import conversation_logger
...
class AdvancedSelfConsistency:
    ...
    def generate_responses(self, system_prompt: str, user_prompt: str) -> List[str]:
        ...
        for _ in range(self.num_samples):
            ...
            # Log provider call
            if hasattr(halumanage, 'conversation_logger') and halumanage.conversation_logger and self.request_id:
                response_dict = response.model_dump() if hasattr(response, 'model_dump') else response
                halumanage.conversation_logger.log_provider_call(self.request_id, provider_request, response_dict)

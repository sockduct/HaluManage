...
class LiteLLMWrapper:
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
       ...
       # print("In litellm_wrapper.py - API KEY :", api_key)
    ...
    class Chat:
        class Completions:
            ...
            def create(model: str, messages: List[Dict[str, str]], **kwargs):
                print("In litellm_wrapper.py - model:", model)
                ...
                return response
                # For Gemini models, add safety settings and specify the provider
                return completion(
                    model=model,
                    messages=messages,
                    **kwargs,
            ...
            # For all other models, just pass them through to litellm

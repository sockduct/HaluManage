"""
Deep Research Plugin - halumanage Plugin Interface
...
from halumanage.plugins.deep_research import DeepResearcher
...
class DeepResearchClientWrapper:
    ...
    def _detect_client_type(self):
        ...
        # Check for LiteLLM wrapper
            ...
            return 'litellm'
        # All other clients (halumanage inference, etc.)
        else:
            return 'other'
        ...
        class Completions:
            ...
            def create(self, **kwargs):
                ...
                if self.parent.client_type == 'openai_compatible':
                    ...
                    # For other clients (like halumanage), just pass through

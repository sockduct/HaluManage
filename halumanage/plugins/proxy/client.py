...
class ProxyClient:
    ...
    class _Completions:
        ...
        def _filter_kwargs(self, kwargs: dict) -> dict:
            """Filter out halumanage-specific parameters that shouldn't be sent to providers"""
            halumanage_params = {
                'halumanage_approach', 'proxy_wrap', 'wrapped_approach', 'wrap',
                'mcts_simulations', 'mcts_exploration', 'mcts_depth',
                'best_of_n', 'rstar_max_depth', 'rstar_num_rollouts', 'rstar_c'
            }
            return {k: v for k, v in kwargs.items() if k not in halumanage_params}
        ...
        def create(self, **kwargs):
            ...
            try:
                ...
                while healthy_providers:
                    ...
                    try:
                        # Map model name if needed and filter out halumanage-specific parameters

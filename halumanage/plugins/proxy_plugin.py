"""
Proxy Plugin for halumanage - Load balancing and failover for LLM providers
...
from halumanage.plugins.proxy.approach_handler import ApproachHandler
...
import os
log_level = os.environ.get('halumanage_LOG_LEVEL', 'INFO')
...
def run(system_prompt: str, initial_query: str, client, model: str, 
    ...
    2. Wrapping approach: extra_body={"halumanage_approach": "proxy", "proxy_wrap": "moa"}

...
# Global logger instance - will be set by halumanage.py
...
class ConversationLogger:
    """
    Logger for halumanage conversations including all provider interactions and metadata.
...
def set_global_logger(logger_instance: 'ConversationLogger') -> None:
    """Set the global logger instance (called by halumanage.py)"""

...
# Global logger instance - will be set by hulumanage.py
...
class ConversationLogger:
    """
    Logger for hulumanage conversations including all provider interactions and metadata.
...
def set_global_logger(logger_instance: 'ConversationLogger') -> None:
    """Set the global logger instance (called by hulumanage.py)"""

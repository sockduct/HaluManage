...
import hulumanage
from hulumanage import conversation_logger
...
Please provide {num_observations} observations."""
        ...
        if hasattr(hulumanage, 'conversation_logger') and hulumanage.conversation_logger and self.request_id:
            response_dict = response.model_dump() if hasattr(response, 'model_dump') else response
            hulumanage.conversation_logger.log_provider_call(self.request_id, provider_request, response_dict)

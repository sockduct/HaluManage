"""
Deep Research Plugin - hulumanage Plugin Interface
...
from hulumanage.plugins.deep_research import DeepResearcher
...
class DeepResearchClientWrapper:
    ...
    def _detect_client_type(self):
        ...
        # Check for LiteLLM wrapper
            ...
            return 'litellm'
        # All other clients (hulumanage inference, etc.)
        else:
            return 'other'
        ...
        class Completions:
            ...
            def create(self, **kwargs):
                ...
                if self.parent.client_type == 'openai_compatible':
                    ...
                    # For other clients (like hulumanage), just pass through

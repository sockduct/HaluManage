...
class ApproachHandler:
    ...
    def _discover_approaches(self):
        """Discover built-in approaches from halumanage package"""
        approach_modules = {
            'mcts': ('halumanage.mcts', 'chat_with_mcts'),
            'bon': ('halumanage.bon', 'best_of_n_sampling'),
            'moa': ('halumanage.moa', 'mixture_of_agents'),
            'rto': ('halumanage.rto', 'round_trip_optimization'),
            'self_consistency': ('halumanage.self_consistency', 'advanced_self_consistency_approach'),
            'pvg': ('halumanage.pvg', 'inference_time_pv_game'),
            'z3': ('halumanage.z3_solver', None),  # Special case
            'rstar': ('halumanage.rstar', None),  # Special case
            'cot_reflection': ('halumanage.cot_reflection', 'cot_reflection'),
            'plansearch': ('halumanage.plansearch', 'plansearch'),
            'leap': ('halumanage.leap', 'leap'),
            're2': ('halumanage.reread', 're2_approach'),
            'cepo': ('halumanage.cepo.cepo', 'cepo'),  # CEPO approach
        }
    ...
    def _discover_plugins(self):
        ...
        try:
            ...
            package_dir = Path(halumanage.__file__).parent / 'plugins'

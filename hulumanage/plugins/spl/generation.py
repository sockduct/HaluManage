...
from hulumanage.plugins.spl.strategy import Strategy, StrategyDatabase
from hulumanage.plugins.spl.utils import extract_thinking
from hulumanage.plugins.spl.prompts import (
    PROBLEM_CLASSIFICATION_PROMPT,
    STRATEGY_GENERATION_PROMPT
)
from hulumanage.plugins.spl.config import (
    VALID_PROBLEM_TYPES,
    DEFAULT_MAX_TOKENS,
